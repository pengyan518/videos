...
export default function SlideNextButton({data}: SlideNextButtonProps) {
  ...
  return (
    <button
      className={`display-none md:block rounded-full p-3 absolute flex items-center justify-center cursor-pointer z-10 w-12 h-12 right-4 bottom-4 bg-[#beb1a0] hover:bg-[#fff] text-white hover:text-[#beb1a0] ${
